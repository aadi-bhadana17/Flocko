...
import { getStaffRestaurant } from '../../api/userService';
...
const RestaurantStaffDashboard = () => {
    ...
    const fetchRestaurantId = async () => {
        try {
            const data = await getStaffRestaurant();
    ...
    const handleKitchenUpdate = async (e) => {
        ...
        setKitchenBusy(true);
        try {
            const response = await updateKitchenStatus(restaurantId, kitchenLoadIndicator);
                    ...
                    <div className="sd-kitchen-wrap">
                        <form className="sd-kitchen-form" onSubmit={handleKitchenUpdate}>
                            ...
                            <p className="sd-kitchen-context">
                                Restaurant ID: <strong>{restaurantId || 'Not detected yet'}</strong>
                            </p>
